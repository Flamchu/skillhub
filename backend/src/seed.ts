...
async function main() {
	...
	const skillsData = [
		...
		// Programming Languages
		{
			...
			description: "Various programming languages and their applications",
			children: [
				{ name: "C Language", slug: "c-language", description: "General-purpose programming language" },
				{ name: "C++ Language", slug: "cpp-language", description: "General-purpose programming language with object-oriented features" },
				{ name: "C# Language", slug: "csharp-language", description: "Multi-paradigm programming language" },
				{ name: "Java Language", slug: "java-language", description: "Object-oriented programming language" },
				{ name: "Python Language", slug: "python-language", description: "High-level interpreted programming language" },
				{ name: "JavaScript Language", slug: "javascript-language", description: "Programming language for web development" },
				{ name: "TypeScript Language", slug: "typescript-language", description: "Typed superset of JavaScript" },
				{ name: "Go Language", slug: "go-language", description: "Statically typed programming language by Google" },
				{ name: "Rust Language", slug: "rust-language", description: "Systems programming language focusing on safety" },
				{ name: "Swift Language", slug: "swift-language", description: "Programming language by Apple" },
				{ name: "Kotlin Language", slug: "kotlin-language", description: "Cross-platform programming language" },
				{ name: "Scala Language", slug: "scala-language", description: "Programming language combining OOP and functional programming" },
				{ name: "Ruby Language", slug: "ruby-language", description: "Dynamic, reflective programming language" },
				{ name: "PHP Language", slug: "php-language", description: "Server-side scripting language" },
				{ name: "R Language", slug: "r-language", description: "Programming language for statistics" },
				{ name: "MATLAB", slug: "matlab-language", description: "Programming platform for engineers and scientists" },
				{ name: "Perl", slug: "perl-language", description: "High-level programming language" },
				{ name: "Lua", slug: "lua-language", description: "Lightweight scripting language" },
				{ name: "Haskell", slug: "haskell-language", description: "Purely functional programming language" },
				{ name: "Clojure", slug: "clojure-language", description: "Dynamic programming language that runs on the JVM" },
				{ name: "F#", slug: "fsharp-language", description: "Functional-first programming language" },
				{ name: "Zig", slug: "zig-language", description: "General-purpose programming language" },
				{ name: "Assembly", slug: "assembly-language", description: "Low-level programming language" },
				{ name: "COBOL", slug: "cobol-language", description: "Business-oriented programming language" },
				{ name: "Fortran", slug: "fortran-language", description: "Programming language for scientific computing" },
			],
		},
		// Game Development
		{
