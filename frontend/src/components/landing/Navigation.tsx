		...
		<nav className={`px-6 py-6 bg-surface/90 dark:bg-gray-900/90 backdrop-blur-sm border-b border-border dark:border-gray-700 ${className}`}>
			<div className="max-w-7xl mx-auto flex justify-between items-center">
				...
				<div className="flex items-center gap-4">
					<LanguageSwitcher />
					<Link href="/login" className="px-6 py-3 text-foreground-muted hover:text-foreground font-medium transition-colors rounded-sm hover:bg-surface-hover/70 dark:hover:bg-gray-800">
						{t("login")}
					</Link>
