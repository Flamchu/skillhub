...
export function AIWorkflowPrompt() {
	...
	return (
		<div className="relative overflow-hidden rounded-2xl border-2 border-primary/30 dark:border-primary/40 bg-gradient-to-br from-primary/5 via-purple/5 to-pink/5 dark:from-primary/10 dark:via-purple/10 dark:to-pink/10 hover:shadow-xl transition-all duration-300">
			{/* Decorative background elements */}
			<div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-primary/10 to-purple/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 animate-pulse" />
			<div
				className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-br from-purple/10 to-pink/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 animate-pulse"
			...
			<div className="relative p-8">
				...
				<div className="flex items-start justify-between mb-6">
					<div className="flex items-center space-x-3">
						<div className="w-14 h-14 bg-gradient-to-br from-primary to-purple rounded-xl flex items-center justify-center shadow-xl">
				...
				<div className="space-y-4">
					...
					<div className="grid md:grid-cols-3 gap-4 mt-6">
						<div className="group relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-5 border-2 border-gray-200/50 dark:border-gray-700/50 hover:border-primary/40 dark:hover:border-primary/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
							<div className="absolute -top-3 -left-3 w-8 h-8 bg-gradient-to-br from-primary to-purple rounded-full flex items-center justify-center text-white font-bold shadow-xl group-hover:scale-110 transition-transform">
								1
							</div>
						...
						<div className="group relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-5 border-2 border-gray-200/50 dark:border-gray-700/50 hover:border-purple/40 dark:hover:border-purple/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
							<div className="absolute -top-3 -left-3 w-8 h-8 bg-gradient-to-br from-purple to-pink rounded-full flex items-center justify-center text-white font-bold shadow-xl group-hover:scale-110 transition-transform">
								2
							</div>
							<div className="flex items-center space-x-2 mb-2">
						...
						<div className="group relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-5 border-2 border-gray-200/50 dark:border-gray-700/50 hover:border-success/40 dark:hover:border-success/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
							<div className="absolute -top-3 -left-3 w-8 h-8 bg-gradient-to-br from-success to-info rounded-full flex items-center justify-center text-white font-bold shadow-xl group-hover:scale-110 transition-transform">
								3
							</div>
							<div className="flex items-center space-x-2 mb-2">
					...
					<div className="flex flex-col sm:flex-row gap-4 mt-8">
						<Link href="/ai-skills" className="flex-1">
							<Button
								className="w-full bg-gradient-to-r from-primary to-purple hover:from-primary-600 hover:to-purple-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-200 py-6 text-lg font-semibold"
								size="lg"
							>
