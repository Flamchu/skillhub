		...
		>
			...
			<div className="flex justify-center mb-6">
				<Button
					...
					className="px-6 py-3 bg-gradient-to-r from-purple to-pink text-white rounded-lg hover:from-purple-600 hover:to-pink-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
				>
					{isGenerating ? (
						<>
