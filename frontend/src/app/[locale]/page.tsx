		...
		<div className="min-h-screen bg-gradient-to-br from-primary-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-gray-100">
			...
			<section className="px-6 py-20">
				<div className="max-w-6xl mx-auto">
					<div className="bg-gradient-to-r from-primary/10 via-purple/10 to-pink/10 rounded-3xl p-12 border border-primary/20">
						<div className="text-center mb-12">
							<div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary/20 to-purple/20 text-primary rounded-full text-sm font-semibold mb-6 border border-primary/30">
								🤖 AI-Powered Learning
							</div>
						...
						<div className="grid md:grid-cols-3 gap-8 mb-12">
							<div className="text-center">
								<div className="w-20 h-20 bg-gradient-to-br from-primary to-purple rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
							...
							<div className="text-center">
								<div className="w-20 h-20 bg-gradient-to-br from-success to-info rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
									<span className="text-3xl">🚀</span>
								</div>
							...
							<div className="text-center">
								<div className="w-20 h-20 bg-gradient-to-br from-warning to-pink rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
									<span className="text-3xl">✨</span>
								</div>
						...
						<div className="text-center">
							<Link
								...
								className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-primary to-purple text-white font-semibold rounded-lg hover:from-primary-600 hover:to-purple-600 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
							>
