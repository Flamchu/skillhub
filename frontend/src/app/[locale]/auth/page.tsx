					...
					<GlassCard>
						...
						<div className="p-8">
							...
							<div className="mt-8 text-center">
								...
								<button
									onClick={toggleMode}
									className="px-6 py-2 text-primary hover:text-purple font-semibold bg-gradient-to-r from-primary/5 to-purple/5 hover:from-primary/10 hover:to-purple/10 rounded-lg border border-primary/20 hover:border-primary/30 transition-all duration-200 hover:scale-105"
								>
